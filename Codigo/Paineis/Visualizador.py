...
class Visualizador:
    ...
    def desenhar(self, tela, jogadores, jogador_ativo_id):
        ...
        for jogador, linha in zip(jogadores, self._linhas(len(jogadores))):
            ...
            pygame.draw.rect(tela, (86, 94, 106) if ativo else (62, 66, 74), linha, border_radius=8)
            pygame.draw.rect(tela, (166, 174, 186) if ativo else (112, 118, 128), linha, width=2, border_radius=8)
